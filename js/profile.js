...
// //todo pulling filepath for randomizer algo
//     function pokePics() {
//         path = URL("pokehashLibs/pokemons/pokemon" + num + ".png")
//         let num = 
//         for (let j = 0; j < 8; j++) {
//     }
...
function getRegion(region){
    ...
    else{ //!for texting purposes. Should be "undisclosed"
        return "Kanto"
    }
}
